...
<article
    data-card="musician"
    class="flex flex-col w-full h-full rounded-xl overflow-hidden border border-dark/10 bg-white shadow-sm hover:shadow-md transition-shadow duration-200 cursor-pointer"
    tabindex="0"
>
    <div class="relative h-52 shrink-0 bg-dark/5">
        ...
        <button
            type="button"
            class="absolute top-3 right-3 w-10 h-10 flex items-center justify-center rounded-full bg-white/75 backdrop-blur-sm text-dark/40 hover:text-accent hover:bg-white/90 transition-colors duration-200 cursor-pointer focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-accent"
    ...
    <a
        href="{{ $url }}"
        class="group relative overflow-hidden flex items-center min-h-[48px] px-5 border-t border-dark/10 text-sm font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-accent"
    >
