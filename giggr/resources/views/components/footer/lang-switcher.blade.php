<div x-data="{ lang: localStorage.getItem('lang') ?? 'fr' }"
    ...
    <button @click="lang = 'fr'; localStorage.setItem('lang', 'fr')"
            ...
            class="text-base font-medium tracking-widest uppercase transition-colors duration-150 cursor-pointer focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-accent rounded-sm">
        FR
    </button>
