    ...
    @if ($isPendingRequest)
        <div class="flex items-center gap-1.5 shrink-0">
            ...
            <button
                ...
                class="px-3 py-1.5 rounded-md text-xs font-medium bg-accent text-on-dark hover:opacity-90 transition-opacity duration-150 cursor-pointer focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-accent"
            >
    ...
    @elseif ($showActions && $conversation)
        <div class="flex items-center gap-0.5 shrink-0">
            <button
                ...
                class="w-9 h-9 flex items-center justify-center rounded-full text-subtle hover:text-danger hover:bg-dark/5 transition-colors duration-150 cursor-pointer focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-accent"
