    ...
    >
        ...
        <div class="flex items-end gap-2">
            ...
            <button
                ...
                class="w-10 h-10 shrink-0 rounded-full bg-accent text-on-dark flex items-center justify-center hover:opacity-90 transition-opacity duration-150 cursor-pointer focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-accent disabled:opacity-40 disabled:cursor-not-allowed"
            >
