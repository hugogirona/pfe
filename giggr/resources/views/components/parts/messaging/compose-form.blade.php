...
>
    ...
    <div class="relative rounded-xl bg-dark/5 has-[textarea:focus]:bg-bg has-[textarea:focus]:ring-1 has-[textarea:focus]:ring-accent transition-colors duration-150">
        <textarea
            ...
            class="block w-full max-h-60 resize-none scrollbar-none bg-transparent pl-4 pr-16 py-2 text-sm leading-6 text-dark placeholder-dark/40 focus:outline-none"
        ...
        <button
            ...
            class="absolute bottom-1.5 right-1.5 w-13 h-13 flex items-center justify-center rounded-lg text-accent hover:bg-accent/10 transition-colors duration-150 cursor-pointer focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-accent disabled:opacity-40 disabled:cursor-not-allowed"
        >
