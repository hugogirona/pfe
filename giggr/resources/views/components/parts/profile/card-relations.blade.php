...
<div class="flex items-center justify-center gap-1 py-3 border-b border-dark/[0.07] text-sm">
    <button
        ...
        class="flex items-baseline gap-1.5 px-3 py-1.5 rounded-md text-dark hover:text-accent transition-colors duration-150 cursor-pointer focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-accent"
    ...
    >
        ...
        <span class="text-dark/50">{{ __('social.tab_followed') }}</span>
    </button>
</div>
