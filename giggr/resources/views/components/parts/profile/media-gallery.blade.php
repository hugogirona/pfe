        ...
        @if ($isOwner)
            <div class="relative" x-data="{ open: false }">
                ...
                <div
                    ...
                    class="absolute right-0 mt-2 w-52 bg-white rounded-xl border border-dark/10 shadow-lg overflow-hidden z-10"
                    role="menu"
                    style="display: none"
                >
                    ...
                    <div
                        role="menuitem"
                        aria-disabled="true"
                        class="flex items-center gap-2.5 px-4 py-3 text-sm text-dark/30 cursor-not-allowed"
                    >
                        <x-icon name="photo" class="w-4 h-4 text-dark/20"/>
                        <span class="flex-1">{{ __('profile.gallery_add_image') }}</span>
