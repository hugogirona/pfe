...
class extends Component {
    ...
    public function filteredProfiles(): LengthAwarePaginator
    {
        ...
        return Profile::query()
            ...
            ->when($this->filterInstruments, fn($q) => $q->whereHas('instruments', fn($q2) => $q2->whereIn('instruments.id', $this->filterInstruments)))
            ->when($this->filterGenres, fn($q) => $q->whereHas('genres', fn($q2) => $q2->whereIn('genres.id', $this->filterGenres)))
